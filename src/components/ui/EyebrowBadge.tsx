...
export function EyebrowBadge({ children, className = "" }: Props) {
  return (
    <span
      ...
      style={{
        boxShadow:
          "inset 0 1px 0 rgba(255,255,255,0.06), 0 0 24px -8px rgba(230,33,42,0.25)",
      }}
    >
      <span className="inline-block h-1.5 w-1.5 rounded-full bg-accent shadow-[0_0_10px_rgba(230,33,42,0.85)]" />
      {children}
    </span>
  );
}
