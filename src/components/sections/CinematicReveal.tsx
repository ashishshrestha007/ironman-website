    ...
    >
      ...
      >
        ...
        <div className="pointer-events-none absolute right-6 top-28 z-10 flex max-w-[46ch] flex-col items-end gap-5 text-right md:right-12 md:top-32">
          <EyebrowBadge>PROFESSIONAL MILESTONES // EVOLUTION</EyebrowBadge>
          <div className="relative self-stretch">
            ...
            >
              Innovation is
              <br />
              <span className="text-accent">Constant.</span>
            </h2>
            <h2
              ref={h2IronManRef}
            ...
            >
              Code is
              <br />
              <span className="text-accent">Empowerment.</span>
            </h2>
          </div>
          <p className="max-w-[42ch] font-sans text-sm leading-relaxed text-zinc-400 md:text-base">
            From initial concepts to complex enterprise solutions. Every project is a step towards mastering the craft of software engineering.
          </p>
        </div>
        ...
        <div className="pointer-events-none absolute right-6 top-20 z-10 flex items-center gap-3 md:right-10 md:top-24">
          ...
          <span
            aria-hidden
            className="inline-block h-1.5 w-1.5 rounded-full bg-accent shadow-[0_0_10px_rgba(230,33,42,0.85)]"
          />
        </div>
        ...
        {!loaded && (
          <div className="absolute inset-0 z-30 flex flex-col items-center justify-center gap-5 bg-background px-6">
            <EyebrowBadge>PORTFOLIO DATA // RESTORING</EyebrowBadge>
            ...
            <p className="font-mono text-[11px] uppercase tracking-[0.28em] text-zinc-500">
              Rendering Projects &nbsp;&middot;&nbsp; {Math.round(loadProgress * 100)}%
            </p>
          </div>
        )}
      </div>
