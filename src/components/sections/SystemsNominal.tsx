...
const telemetry = [
  { label: "Backend Dev", value: "95%", note: "Python, Django, FastAPI" },
  { label: "Frontend Stack", value: "90%", note: "React, Next.js, TypeScript" },
  { label: "Database Management", value: "85%", note: "MySQL, PostgreSQL, MongoDB" },
  { label: "AI Integration", value: "80%", note: "LLMs, Automation, RAG" },
];
    ...
    >
      <div className="mx-auto flex max-w-[1400px] flex-col gap-16 md:grid md:grid-cols-[5fr_4fr] md:gap-20">
        <AnimatedSection className="flex flex-col gap-8">
          <AnimatedItem>
            <EyebrowBadge>CORE COMPETENCIES // SYSTEMS NOMINAL</EyebrowBadge>
          </AnimatedItem>
          <AnimatedItem>
          ...
          <AnimatedItem>
            <p className="max-w-[48ch] font-sans text-base leading-relaxed text-zinc-400 md:text-lg">
              Passionate about creating innovative digital solutions. Specializing in 
              full-stack development with a focus on scalable, user-centric 
              applications that solve real-world problems. Every line of code is 
